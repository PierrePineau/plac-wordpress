...
<div class="flex flex-col md:flex-row min-h-screen">
  <section class="w-full md:w-1/2 bg-primary-800 py-12 flex">
    <div class="flex-col gap-60 container px-6 md:px-10 inline-flex">
      ...
      <div class="mt-8 flex justify-center md:justify-start space-x-6">
        <a href="https://www.facebook.com/people/PLAC-Gestion/61569470524277" target="_blank" rel="noopener">
        ...
        <a href="https://www.linkedin.com/company/plac-gestion" target="_blank" rel="noopener">
          <svg fill="currentColor" viewBox="0 0 24 24" class="w-6 h-6 text-white">
